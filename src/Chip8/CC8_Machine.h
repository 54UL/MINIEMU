...
#define CHIP_8_VRAM_HEIGHT 32 / CHIP_8_VERTICAL_BIT_PAGE_SIZE
#define CHIP_8_VRAM_SIZE CHIP_8_VRAM_WIDTH * CHIP_8_VRAM_HEIGHT

#define CHIP_8_FOREGROUND_DISPLAY_COLOR 0xFFFFFFFF
#define CHIP_8_BACKGROUND_DISPLAY_COLOR 0X00000000
